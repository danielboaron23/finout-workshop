      ...
      <div className="bg-surface-primary flex flex-col gap-[8px] items-start w-full">
        ...
        <div className="flex flex-col items-start overflow-clip w-full">
          ...
          <div className="flex flex-col gap-[8px] items-start w-full">
            ...
            <button
              onClick={onNewFolder}
              className="bg-surface-primary border-2 border-solid border-[#1570ef] flex gap-[6px] items-center justify-center min-h-[32px] px-[12px] py-[6px] rounded-[8px] w-full cursor-pointer"
            >
              <span className="overflow-clip relative shrink-0 size-[16px]">
