...
function SparkleButton() {
  return (
    <button className="bg-surface-primary border border-solid border-border-muted flex items-center justify-center p-[8px] rounded-[8px] shrink-0 size-[36px] cursor-pointer">
...
function ToolbarChip({
  ...
  return (
    <button className="bg-surface-primary border border-solid border-border-muted flex gap-[8px] items-center justify-center min-h-[36px] px-[16px] py-[8px] rounded-[8px] shrink-0 cursor-pointer">
      {icon}
    ...
    <div className="flex items-center shrink-0">
      <button
        ...
        className={`flex gap-[8px] h-[36px] items-center justify-center px-[16px] py-[7px] rounded-l-[8px] shrink-0 cursor-pointer border-solid ${
          active === "cost"
            ? "bg-blue-50 border border-border-primary"
            : "bg-surface-primary border-t border-b border-l border-neutral-300"
        }`}
      >
        <span
          className={`font-sans font-medium text-[12px] whitespace-nowrap ${
            active === "cost" ? "leading-[16px] text-blue-400" : "leading-[20px] text-text-primary"
          }`}
        >
          Cost
        </span>
      ...
      <button
        ...
        className={`flex gap-[8px] h-[36px] items-center justify-center px-[16px] py-[7px] rounded-r-[8px] shrink-0 cursor-pointer border-solid ${
          active === "usage"
            ? "bg-blue-50 border border-border-primary"
            : "bg-surface-primary border-t border-b border-r border-neutral-300"
        }`}
      >
        <span
          className={`font-sans font-medium text-[12px] whitespace-nowrap ${
            active === "usage" ? "leading-[16px] text-blue-400" : "leading-[20px] text-text-primary"
          }`}
        >
          Usage
        </span>
    ...
    <Dropdown
      ...
      trigger={() => (
        <div className="flex items-start shrink-0">
          <button className="bg-white border border-solid border-border-muted flex items-center pl-[4px] pr-[8px] py-[2px] rounded-[8px] shrink-0 cursor-pointer">
...
export function MegaBillToolbar(props: MegaBillToolbarProps = {}) {
  ...
  return (
    <div className="bg-white border border-solid border-neutral-100 flex items-start justify-between px-[16px] py-[17px] rounded-[6px] w-full">
      {/* Left group */}
